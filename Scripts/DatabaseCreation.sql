IF NOT EXISTS (SELECT * FROM sys.databases WHERE name = N'KoreAssignment_Sindoora_Rao')
BEGIN
    CREATE DATABASE [KoreAssignment_Sindoora_Rao];
END
GO

USE [KoreAssignment_Sindoora_Rao]
GO
